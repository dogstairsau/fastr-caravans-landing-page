      ...
      <div className="container-page relative">
        <div className="grid lg:grid-cols-[1.2fr_minmax(380px,1fr)] gap-12 lg:gap-16 items-center">
          <div className="min-w-0">
            <h2 className="font-[var(--font-display)] text-[clamp(1.9rem,5.5vw,5rem)] font-bold leading-[1] tracking-[-0.035em]">
            ...
            <div className="mt-7 md:mt-8 flex items-center gap-5 sm:gap-8 md:gap-10">
              ...
              <div>
                <div className="font-[var(--font-display)] text-2xl sm:text-3xl md:text-4xl font-bold tracking-[-0.025em] leading-none coral-word">30+</div>
